...
export function ExpiredPanel({
  ...
  return (
    <>
      ...
      <div className="w-80 flex-shrink-0 bg-white dark:bg-gray-800 border-l-2 border-gray-200 dark:border-gray-700 h-full overflow-y-auto pb-24 no-scrollbar">
        <div className="sticky top-0 bg-white dark:bg-gray-800 border-b-2 border-gray-200 dark:border-gray-700 p-4 z-10 flex items-center gap-4">
